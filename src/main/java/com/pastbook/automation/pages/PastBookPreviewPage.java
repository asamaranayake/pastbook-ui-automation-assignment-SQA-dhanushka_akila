 ...
 *
 */
public class PastBookPreviewPage extends PageBase {
	...
	public PastBookPreviewPage(WebDriver driver) {
		super(driver);
	}
	...
	public PastBookPreviewPage clickUserEmailLink() {
		use_email_link.click();
		return this;
	}
	
	public PastBookPreviewPage enterEmail(String userName) {
		email_textbox.sendKeys(userName);
		return this;
	}
	
	public PastBookPreviewPage clickEmailSubmitButton() {
